        ...
        <div className="container" style={{padding:"2%"}}>
            <div className="row">
                <div className="col-md-6">
                    <img style={{height:"300px",width:"100%",padding:"20px",paddingTop:"50px"}} src={project1} alt=".."/>
                    
                </div>
                <div className="col-md-6">
                   <h2 style={{paddingTop:"50px",borderBottom:"4px solid gray", textAlign:"center" ,paddingBottom:"5px"}}>Github Finder Using JavaScript</h2>
                   <br/>
            ...
            <a href="https://nahid2194.github.io/Github_Finder_JavaScript/" ><Button size="large" variant="contained" color="primary">
